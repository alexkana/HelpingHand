function addOrgForm(){
    ...
    document.getElementById("add_org_row").innerHTML = "<td>-</td>" +
        "<td><input id='org_title' style='border:none' type='text' required name='org_name' form='org_add_form'></td>" +
        ...
        "<td><button class='btn btn-success' type='submit' form='org_add_form'>Προσθήκη</td>"
    document.getElementById('add_org_row').scrollIntoView({behavior:"smooth"});
    $('#org_title').select();
}